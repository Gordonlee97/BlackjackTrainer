        ...
        >
          ...
          >
            ...
            <div className="text-center mb-5">
              ...
              <p className="text-xs text-white/40 mt-1.5 tracking-widest uppercase">
            ...
            <div className="space-y-2.5 mb-5">
              <div className="flex justify-between items-center rounded-xl px-5 py-3.5"
                style={{ background: 'rgba(220,38,38,0.12)', border: '1px solid rgba(220,38,38,0.18)' }}>
                <span className="text-red-300/80 text-sm font-medium">You played</span>
              ...
              <div className="flex justify-between items-center rounded-xl px-5 py-3.5"
                ...
                <span className="text-emerald-300/80 text-sm font-medium">Correct play</span>
